...
#set_property -dict { PACKAGE_PIN L10   IOSTANDARD LVCMOS33 } [get_ports { v_n }]; #v_p
#set_property -dict { PACKAGE_PIN K9    IOSTANDARD LVCMOS33 } [get_ports { v_p }]; #v_n
set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports { xa_n[0] }]; #IO_L1N_T0_AD0N_35 Sch=ad0_p
set_property -dict { PACKAGE_PIN C20   IOSTANDARD LVCMOS33 } [get_ports { xa_p[0] }]; #IO_L1P_T0_AD0P_35 Sch=ad0_n
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports { xa_p[1] }]; #IO_L15P_T2_DQS_AD12P_35 Sch=ad12_p
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 } [get_ports { xa_n[1] }]; #IO_L15N_T2_DQS_AD12N_35 Sch=ad12_n
